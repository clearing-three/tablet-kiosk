...
async function fetchWeatherData() {
  ...
  try {
    ...
    document.getElementById('weather-icon').data =
...
function updateSunMoonTimes(data) {
  document.getElementById('sunrise-time').textContent = formatTimeFromUnix(
    data.current.sunrise
  )
  document.getElementById('sunset-time').textContent = formatTimeFromUnix(
    data.current.sunset
  )
